...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      <li className="font-poppins font-bold text-base-content"><NavLink to="/">Home</NavLink></li>
      <li className="font-poppins font-bold text-base-content"><NavLink to="/all-jobs">All Jobs</NavLink></li>
      <li className="font-poppins font-bold text-base-content"><NavLink to="/blogs">Blogs</NavLink></li>
      {user && (
        <>
          <li className="font-poppins font-bold text-base-content"><NavLink to="/add-job">Add A Job</NavLink></li>
          <li className="font-poppins font-bold text-base-content"><NavLink to="/my-jobs">My Jobs</NavLink></li>
          <li className="font-poppins font-bold text-base-content"><NavLink to="/applied-jobs">Applied Jobs</NavLink></li>
        </>
      )}
    </>
  );
  ...
  return (
    <div className="navbar bg-base-100 py-5 flex items-center justify-center shadow-md">
      <div className="navbar-start">
        ...
        <Link to="/" className="btn btn-ghost md:text-xl lg:text-xl font-poppins">
          <div className="flex items-center justify-center">
            <img className="w-auto h-7 md:h-14" src={logo} alt="JobPedia Logo" />
            <h2 className="font-poppins md:text-2xl text-base-content">JobPedia</h2>
          </div>
        </Link>
      </div>
            ...
            <div className="flex gap-2">
              <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar tooltip" data-tip={user?.displayName || 'User name not found'}>
                <div className="w-full rounded-full">
                  <img alt="User profile" referrerPolicy="no-referrer" src={user?.photoURL} />
                </div>
              </div>
